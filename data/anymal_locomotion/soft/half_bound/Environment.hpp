...
class ENVIRONMENT : public RaisimGymEnv {
 ...
 public:
  ...
  explicit ENVIRONMENT(const std::string& resourceDir, const Yaml::Node& cfg, bool visualizable) :
    ...
    deltaTorque_.setZero(12); deltaSpeed_.setZero(12);
...
double gaitGenerationCost()
{
    ...
    if (mode == "canter")
    {
      ...
      phase4_1 = {false, true, true, false};

      phases_ = {phase1_1, phase1_2, phase2_1, phase2_2, phase3_1, phase3_2, phase4_1, phase4_2, flyPhase};

      if ((gaitLogger_ == phase1_1 && prevGaitLogger_ == flyPhase) || (gaitLogger_ == phase1_1 && prevGaitLogger_ == phase1_1) || // 1-ая фаза
      ...
      if ((gaitLogger_ == phase3_2 && prevGaitLogger_ == phase1_1) || (gaitLogger_ == phase4_1))
      {
        reward = reward - 100;
      }
      // if ((gaitLogger_ == phase1_1) || (gaitLogger_ == phase1_2) || 
      //     (gaitLogger_ == phase2_1) || (gaitLogger_ == phase2_2) ||
      //     (gaitLogger_ == phase3_1) || (gaitLogger_ == phase3_2) || (gaitLogger_ == flyPhase))
      // {
      //   reward = reward + 0.5;
      // }
    }
    ...
    if (mode == "pace")
    {
      phase1_1 = {true, false, true, false};
      phase1_2 = {false, true, false, true};
      if ((gaitLogger_ == phase1_1) || (gaitLogger_ == phase1_2) || (gaitLogger_ == flyPhase))
      {
          reward = 1;
      }
    }
    ...
    if (mode == "rotary gallop")
    {
      ...
      // if ((gaitLogger_ == phase1) || (gaitLogger_ == phase2) || (gaitLogger_ == phase3) || (gaitLogger_ == phase4) || (gaitLogger_ == flyPhase))
      // {
      //     reward = 1;
      // }
    }
    ...
    // if (mode == "trot")
    // {
    //   phase1 = {true, false, false, true};
    //   phase2 = {false, true, true, false};
    //   if ((gaitLogger_ == phase1) || (gaitLogger_ == phase2) || (gaitLogger_ == flyPhase))
    //   {
    //       reward = 1;
    //   }
    // }
...
*/
 ...
 private:
  ...
  Eigen::VectorXd gc_init_, gv_init_, gc_, gv_, pTarget_, pTarget12_, vTarget_, deltaTorque_, deltaSpeed_;
  double terminalRewardCoeff_ = -10.0, desired_fps_ = 50.0;
  double roll_ = 0.00, pitch_ = 0.00, yaw_ = 0.00;
